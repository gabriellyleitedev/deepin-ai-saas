...
// ⚠️ SEGURANÇA: JWT_SECRET DEVE estar definido no .env em produção
if (!process.env.JWT_SECRET) {
  throw new Error(
    'ERRO CRÍTICO: JWT_SECRET não definido em .env. ' +
    'Adicione JWT_SECRET=sua-chave-super-segura no arquivo .env'
  );
}
