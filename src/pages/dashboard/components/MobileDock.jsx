                    ...
                    {navItems.map((item, index) => {
                        ...
                        if (index === 0) {
                            return (
                                <button
                                    ...
                                    className={`flex items-center justify-center min-w-10 h-10 rounded-full snap-center transition-all shrink-0 ${isActive
                        ...
                        return (
                            <button
                                ...
                                type="button"
                                onClick={() => setActiveTab(item.value)}
                                className={`flex items-center gap-1 px-2 py-1 rounded-full text-[12px] font-semibold tracking-wide h-8 snap-center transition-all shrink-0 whitespace-nowrap ${isActive
